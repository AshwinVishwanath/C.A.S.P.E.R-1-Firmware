...
constexpr float RAD_PER_DEG = 0.017453292519943295f;
...
void loop() {
  ...
  float gyro_rad[3] = {static_cast<float>(gx * RAD_PER_DEG),
                       static_cast<float>(gy * RAD_PER_DEG),
                       static_cast<float>(gz * RAD_PER_DEG)};
